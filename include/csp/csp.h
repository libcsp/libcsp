...
#if CSP_DEBUG
#define csp_debug(level, format, ...) csp_debug_ex(level, "%"PRIu8" %s:%d " format, my_address, strrchr(__FILE__, _CSP_PATH_SEP_)==NULL ? __FILE__ : strrchr(__FILE__, _CSP_PATH_SEP_)+1, __LINE__, ##__VA_ARGS__)
