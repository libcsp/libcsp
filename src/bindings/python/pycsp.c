...
static PyObject* PyErr_CSPError(const char * message, int error) {
    PyErr_Format(CSPError, "%s, result/error: %d", message, error); // should set error as member
    return NULL;
}
...
static PyObject* pycsp_init(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_init()", res);
    }
...
static PyObject* pycsp_socket(PyObject *self, PyObject *args) {
    ...
    if (socket == NULL) {
        return PyErr_CSPError("csp_socket() - no free sockets/connections", CSP_ERR_NOBUFS);
    }
...
static PyObject* pycsp_send(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (res != 1) {
        return PyErr_CSPError("csp_send()", res);
    }
    PyCapsule_SetPointer(packet_capsule, &CSP_POINTER_HAS_BEEN_FREED);
...
static PyObject* pycsp_transaction(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (res < 1) {
        return PyErr_CSPError("csp_transaction()", res);
    }
...
static PyObject* pycsp_sendto(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_sendto()", res);
    }
    PyCapsule_SetPointer(packet_capsule, &CSP_POINTER_HAS_BEEN_FREED);
...
static PyObject* pycsp_sendto_reply(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_sendto_reply()", res);
    }
...
static PyObject* pycsp_connect(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (conn == NULL) {
        return PyErr_CSPError("csp_connect() timeout or failed", CSP_ERR_TIMEDOUT);
    }
...
static PyObject* pycsp_listen(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_listen()", res);
    }
...
static PyObject* pycsp_bind(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_bind()", res);
    }
...
static PyObject* pycsp_route_start_task(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_route_start_task()", res);
    }
...
static PyObject* pycsp_ping(PyObject *self, PyObject *args) {
    ...
    if (res < 0) {
        return PyErr_CSPError("csp_ping()", res);
    }
...
static PyObject* pycsp_xtea_set_key(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_xtea_set_key()", res);
    }
...
static PyObject* pycsp_rtable_set(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_rtable_set()", res);
    }
...
static PyObject* pycsp_rtable_check(PyObject *self, PyObject *args) {
    ...
    if (res <= 0) {
        return PyErr_CSPError("csp_rtable_check()", res);
    }
    return Py_BuildValue("i", res);
}
...
static PyObject* pycsp_rtable_load(PyObject *self, PyObject *args) {
    ...
    if (res <= 0) {
        return PyErr_CSPError("csp_rtable_load()", res);
    }
    return Py_BuildValue("i", res);
}
...
static PyObject* pycsp_buffer_get(PyObject *self, PyObject *args) {
    ...
    if (packet == NULL) {
        return PyErr_CSPError("csp_buffer_get() - no free buffers or data overrun", CSP_ERR_NOMEM);
    }
...
static PyObject* pycsp_cmp_ident(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_cmp_ident()", res);
    }
...
static PyObject* pycsp_cmp_route_set(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_cmp_route_set()", res);
    }
...
static PyObject* pycsp_cmp_peek(PyObject *self, PyObject *args) {
    ...
    if ((len > CSP_CMP_PEEK_MAX_LEN) || (len > outbuf.len)) {
        return PyErr_CSPError("csp_cmp_peek() - exceeding max size", CSP_ERR_INVAL);
    }
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_cmp_peek()", res);
    }
...
static PyObject* pycsp_cmp_poke(PyObject *self, PyObject *args) {
    ...
    if (len > CSP_CMP_POKE_MAX_LEN) {
        return PyErr_CSPError("csp_cmp_poke() - exceeding max size", CSP_ERR_INVAL);
    }
    struct csp_cmp_message msg;
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_cmp_poke()", res);
    }
...
static PyObject* pycsp_cmp_clock_set(PyObject *self, PyObject *args) {
    ...
    if (sec == 0) {
        return PyErr_CSPError("csp_cmp_clock(set) - seconds are 0", CSP_ERR_INVAL);
    }
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_cmp_clock(set)", res);
    }
...
static PyObject* pycsp_cmp_clock_get(PyObject *self, PyObject *args) {
    ...
    Py_END_ALLOW_THREADS;
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_cmp_clock(get)", res);
    }
...
static PyObject* pycsp_zmqhub_init(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_zmqhub_init()", res);
    }
...
static PyObject* pycsp_can_socketcan_init(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_can_socketcan_open_and_add_interface()", res);
    }
...
static PyObject* pycsp_kiss_init(PyObject *self, PyObject *args) {
    ...
    if (res != CSP_ERR_NONE) {
        return PyErr_CSPError("csp_usart_open_and_add_kiss_interface()", res);
    }
...
static PyObject* pycsp_packet_set_data(PyObject *self, PyObject *args) {
    ...
    if (data.len > (int)csp_buffer_data_size()) {
        return PyErr_CSPError("packet_set_data() - exceeding data size", CSP_ERR_INVAL);
    }
...
PyMODINIT_FUNC PyInit_libcsp_py3(void) {
    ...
    /* Exceptions */
    CSPError = PyErr_NewException((char*)"csp.CSPError", NULL, NULL);

    /* Add exception object to your module */
    PyModule_AddObject(m, "CSPError", CSPError);
