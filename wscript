...
def options(ctx):
    ...
    gr.add_option('--with-max-bind-port', type=int, default=16, help='Set highest bindable port number (inclusive)')
    gr.add_option('--with-max-connections', type=int, default=8, help='Set number of statically allocated connection slots')
